...
func initMapForMission(g *gameMap, missionNumber int) {
	...
	com.hitpoints = 1
	g.addPawn(com)
	g.addPawn(createUnit("tmarine", 8, mapH/2+6, g.factions[0], true))
	g.addPawn(createUnit("tmarine", 9, mapH/2+6, g.factions[0], true))
	g.addPawn(createUnit("tmarine", 10, mapH/2+6, g.factions[0], true))
	g.addPawn(createUnit("tghost", 11, mapH/2+6, g.factions[0], true))
